  ...
  const teamMembers = [
    {
      ...
      bio: "Lecturer of Sri Lanka Institute of Information Technology. Department of Information Technology.",
      github: "https://github.com/wishalyatissera",
    ...
    },
    {
      ...
      bio: "Assistant Lecturer of Sri Lanka Institute of Information Technology. Department of Information Technology.",
    ...
    },
    {
      ...
      bio: "Senior Researcher at Horticultural Crop Research and Development Institute (HORDI) Bandarawela.",
    ...
    },
    {
      ...
      bio: "Focused on disease detection using image processing with fertilizer automation system with amart disease prediction through the weather condition.",
    ...
    },
    {
      ...
      bio: "Focused on Pest Identification using YOLO model and Smart Capturing System with yellow board crop.",
    ...
    },
    {
      ...
      bio: "Focused on weed identification through YOLO and CNN model with smart IoT.",
    ...
    },
    {
      ...
      bio: "Focuses on predict harvesting period through IoT.",
